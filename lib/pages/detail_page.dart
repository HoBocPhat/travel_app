                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              child: AppButton(
                                ...
                                backgroundColor: index != selectedIndex ? AppColors.buttonBackground : Colors.black,
                                borderColor: index != selectedIndex ? AppColors.buttonBackground : Colors.black,
                      ...
                      const SizedBox(height: 10),
                      AppText(text: "You should go to travel. Travelling helps get rid of pressure. Go to the mountain to see the nature", color: AppColors.mainColor)
                    ],
                  ),
                )),
            Positioned(
                ...
                child: Row(
                  children: [
                    AppButton(color: AppColors.textColor2, backgroundColor: Colors.white,
                        borderColor: AppColors.textColor2, size: 60, isText: false,
